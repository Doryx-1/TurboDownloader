...
class DownloadRow:
    ...
    def __init__(self, parent, name: str, on_pause, on_cancel, on_remove):
        ...
        self.pause_btn.grid(row=0, column=2, padx=3, pady=(8, 2))
        ...
        self.cancel_btn.grid(row=0, column=3, padx=3, pady=(8, 2))
        ...
        self.remove_btn.grid(row=0, column=4, padx=(3, 10), pady=(8, 2))
